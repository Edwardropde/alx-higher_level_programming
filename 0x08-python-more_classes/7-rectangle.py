...
class Rectangle:
    ...
    print_symbol = '#'       # Class attribute to store string symbol
    ...
    def __str__(self):
        """
        Returns a string representation of the rectangle using symbol in
        print_symbol
        """
        if self.__width == 0 or self.__height == 0:
            return ""
    ...
    def __repr__(self):
        """
        Returns a string representation of the rectangle and recreate using eval
        """
